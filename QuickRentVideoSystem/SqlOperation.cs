...
namespace QuickRentVideoSystem
{
    ...
    {
        private static SqlConnection myCon = new SqlConnection("Data Source=DESKTOP-7Q26D3G\\SQLEXPRESS;Initial Catalog=QuickRentDB;Integrated Security=True");
        ...
        public static void LoadStat(String type,Label a, Label b, Label c)
        {
            if (type == "booking")
                ...
                b.Font = new Font("Segoe UI Semibold", 15, FontStyle.Bold);
