...
namespace QuickRentVideoSystem
{
    public partial class Dashboard : Form
    {
        ...
        private void stat2Lbl_Click(object sender, EventArgs e)
        {

        }

        private void stat3Lbl_Click(object sender, EventArgs e)
        {

        }

        private void stat3TitleLbl_Click(object sender, EventArgs e)
        {
